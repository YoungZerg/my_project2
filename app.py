...
sidebar = html.Div(
    [
        html.H2("Показатели стран мира", className="display-6", style={"color": "rgb(232, 232, 232)"}),
        html.Hr(),
        html.P(
            "Учебный проект студента БСБО-15-21", className="lead", style={"color": "rgb(232, 232, 232)"}
        ),
        dbc.Nav(
            [
                dbc.NavLink("Карта мира", href="/", active="exact", style={"color": "white"}),
                dbc.NavLink("Страны", href="/page-1", active="exact", style={"color": "white"}),
                dbc.NavLink("Статистика", href="/page-2", active="exact", style={"color": "white"}),
            ],
            vertical=True,
            pills=True,
        ),
